...
import com.noveltea.retention.RetentionProperties;
import com.noveltea.snapshot.SnapshotProperties;
 ...
 */
@Configuration
@EnableConfigurationProperties({AuthProperties.class, LimitProperties.class, CompileProperties.class, SnapshotProperties.class, RetentionProperties.class})
